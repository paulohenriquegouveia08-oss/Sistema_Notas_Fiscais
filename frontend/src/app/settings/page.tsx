      ...
      <div className="space-y-6 max-w-3xl">
        ...
        <Card className="p-6">
          <h3 className="text-lg font-semibold text-text-primary mb-2 flex items-center gap-2">
            ...
            <span className="text-xs font-normal px-2 py-0.5 rounded-full bg-primary/15 text-primary">v1.7.2</span>
          </h3>
          <p className="text-sm text-text-muted mb-4">
          ...
          <div className="p-3 rounded-lg bg-primary/5 border border-primary/20 mb-4">
            <p className="text-xs font-medium text-primary mb-1">Última atualização (v1.7.2)</p>
            <p className="text-xs text-text-muted">Correção do bug "Resposta vazia da API". Retry automático, verificação por chave de acesso, logs de debug, delay entre requests.</p>
          </div>
          ...
          <div className="flex items-center gap-3 flex-wrap">
            <a
              href={`${process.env.NEXT_PUBLIC_API_URL}/devok-monitor/download/DevokMonitor-v1.7.2.exe`}
              download
              className="btn-primary flex items-center gap-2"
            >
              <Download className="h-4 w-4" />
              Baixar DevokMonitor v1.7.2
            </a>
            <a
